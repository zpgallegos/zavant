"""AWS Lambda entry point for daily MLB Stats API acquisition."""
...
from zavant.ingestion.mlb_stats_api.storage.bundles import AcquisitionStorage, s3_acquisition_storage
