"""S3 discovery and validation for immutable Stats API game inputs."""
...
def resolve_current_revisions(
    ...
    The overlap makes the listing-time optimization conservative: recently
    reconciled pointers are reread even when their modification time appears
    older than the cache checkpoint.
    """
...
def pending_revisions(
    ...
    """Return raw revisions absent from the ``games`` completion-marker table."""
