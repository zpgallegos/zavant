"""Composition and integrity checks for one Stats API game projection."""
...
from zavant.projection.mlb_stats_api.boxscore import project_boxscore
...
from zavant.projection.mlb_stats_api.game import project_game_row
from zavant.projection.mlb_stats_api.game_support import project_game_support
from zavant.projection.mlb_stats_api.models import GameProjection, ProjectionSource
from zavant.projection.mlb_stats_api.play_extensions import project_play_extensions
from zavant.projection.mlb_stats_api.plays import project_play_data
...
def project_game(
    ...
    """Project one raw revision through the core analytical contract boundary.

    All table-specific extractors converge here. A projection is returned only
    after schemas, natural keys, and cross-table relationships agree, keeping
    local Parquet and production Iceberg publication behavior aligned.
    """
