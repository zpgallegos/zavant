...
| Storage boundary | Acquisition imports concrete filesystem stores and exchanges `Path` values | Domain-specific protocols and portable artifact references implemented by local and future S3 adapters | Accepted in ADR 0008; local adapters conform |
