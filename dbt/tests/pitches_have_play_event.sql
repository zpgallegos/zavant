select
    ...
    pitch.at_bat_index,
    pitch.event_index,
    pitch.source_revision_id,
    pitch.projection_contract_version
...
left join {{ ref("stg_play_events") }} as event
    on
        ...
        and pitch.source_revision_id = event.source_revision_id
        and pitch.projection_contract_version = event.projection_contract_version
